...
//  tipcalculator
//
//  Created by Zach Lamb
//  Copyright (c) 2016 Zach Lamb. All rights reserved.
//
...
class ViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func onTapGestureRecognized(sender: AnyObject) {
        amountDue.resignFirstResponder()
    ...
    func updateTipTotals() {
        ...
        if amountDue.text!.isEmpty {
            amount = 0.0
        } else {
            amount = Float(amountDue.text!)!
        }
